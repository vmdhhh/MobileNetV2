...
# source: research.object_detection/protos/calibration.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='research.object_detection/protos/calibration.proto',
  package='research.object_detection.protos',
  syntax='proto2',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n)research.object_detection/protos/calibration.proto\x12\x17research.object_detection.protos\"\xe4\x03\n\x11\x43\x61librationConfig\x12P\n\x16\x66unction_approximation\x18\x01 \x01(\x0b\x32..research.object_detection.protos.FunctionApproximationH\x00\x12\x62\n class_id_function_approximations\x18\x02 \x01(\x0b\x32\x36.research.object_detection.protos.ClassIdFunctionApproximationsH\x00\x12J\n\x13sigmoid_calibration\x18\x03 \x01(\x0b\x32+.research.object_detection.protos.SigmoidCalibrationH\x00\x12\\\n\x1d\x63lass_id_sigmoid_calibrations\x18\x04 \x01(\x0b\x32\x33.research.object_detection.protos.ClassIdSigmoidCalibrationsH\x00\x12\x61\n\x1ftemperature_scaling_calibration\x18\x05 \x01(\x0b\x32\x36.research.object_detection.protos.TemperatureScalingCalibrationH\x00\x42\x0c\n\ncalibrator\"L\n\x15\x46unctionApproximation\x12\x33\n\tx_y_pairs\x18\x01 \x01(\x0b\x32 .research.object_detection.protos.XYPairs\"\xe9\x01\n\x1d\x43lassIdFunctionApproximations\x12l\n\x15\x63lass_id_xy_pairs_map\x18\x01 \x03(\x0b\x32M.research.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry\x1aZ\n\x16\x43lassIdXyPairsMapEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12/\n\x05value\x18\x02 \x01(\x0b\x32 .research.object_detection.protos.XYPairs:\x02\x38\x01\"\\\n\x12SigmoidCalibration\x12\x46\n\x12sigmoid_parameters\x18\x01 \x01(\x0b\x32*.research.object_detection.protos.SigmoidParameters\"\x8b\x02\n\x1a\x43lassIdSigmoidCalibrations\x12}\n\x1f\x63lass_id_sigmoid_parameters_map\x18\x01 \x03(\x0b\x32T.research.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry\x1an\n ClassIdSigmoidParametersMapEntry\x12\x0b\n\x03key\x18\x01 \x01(\x05\x12\x39\n\x05value\x18\x02 \x01(\x0b\x32*.research.object_detection.protos.SigmoidParameters:\x02\x38\x01\"/\n\x1dTemperatureScalingCalibration\x12\x0e\n\x06scaler\x18\x01 \x01(\x02\"\xab\x01\n\x07XYPairs\x12\x39\n\x08x_y_pair\x18\x01 \x03(\x0b\x32\'.research.object_detection.protos.XYPairs.XYPair\x12\x45\n\x12training_data_type\x18\x02 \x01(\x0e\x32).research.object_detection.protos.TrainingDataType\x1a\x1e\n\x06XYPair\x12\t\n\x01x\x18\x01 \x01(\x02\x12\t\n\x01y\x18\x02 \x01(\x02\"0\n\x11SigmoidParameters\x12\r\n\x01\x61\x18\x01 \x01(\x02:\x02-1\x12\x0c\n\x01\x62\x18\x02 \x01(\x02:\x01\x30*N\n\x10TrainingDataType\x12\x15\n\x11\x44\x41TA_TYPE_UNKNOWN\x10\x00\x12\x0f\n\x0b\x41LL_CLASSES\x10\x01\x12\x12\n\x0e\x43LASS_SPECIFIC\x10\x02'
)

_TRAININGDATATYPE = _descriptor.EnumDescriptor(
  name='TrainingDataType',
  full_name='research.object_detection.protos.TrainingDataType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_CALIBRATIONCONFIG = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.CalibrationConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='function_approximation', full_name='research.object_detection.protos.CalibrationConfig.function_approximation', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='class_id_function_approximations', full_name='research.object_detection.protos.CalibrationConfig.class_id_function_approximations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sigmoid_calibration', full_name='research.object_detection.protos.CalibrationConfig.sigmoid_calibration', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='class_id_sigmoid_calibrations', full_name='research.object_detection.protos.CalibrationConfig.class_id_sigmoid_calibrations', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='temperature_scaling_calibration', full_name='research.object_detection.protos.CalibrationConfig.temperature_scaling_calibration', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='calibrator', full_name='research.object_detection.protos.CalibrationConfig.calibrator',
...
_FUNCTIONAPPROXIMATION = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.FunctionApproximation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='x_y_pairs', full_name='research.object_detection.protos.FunctionApproximation.x_y_pairs', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDFUNCTIONAPPROXIMATIONS_CLASSIDXYPAIRSMAPENTRY = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='research.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='research.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDFUNCTIONAPPROXIMATIONS = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.ClassIdFunctionApproximations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_id_xy_pairs_map', full_name='research.object_detection.protos.ClassIdFunctionApproximations.class_id_xy_pairs_map', index=0,
...
_SIGMOIDCALIBRATION = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.SigmoidCalibration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='sigmoid_parameters', full_name='research.object_detection.protos.SigmoidCalibration.sigmoid_parameters', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDSIGMOIDCALIBRATIONS_CLASSIDSIGMOIDPARAMETERSMAPENTRY = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='research.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry.key', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='research.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CLASSIDSIGMOIDCALIBRATIONS = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.ClassIdSigmoidCalibrations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='class_id_sigmoid_parameters_map', full_name='research.object_detection.protos.ClassIdSigmoidCalibrations.class_id_sigmoid_parameters_map', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TEMPERATURESCALINGCALIBRATION = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.TemperatureScalingCalibration',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='scaler', full_name='research.object_detection.protos.TemperatureScalingCalibration.scaler', index=0,
...
_XYPAIRS_XYPAIR = _descriptor.Descriptor(
  name='XYPair',
  full_name='research.object_detection.protos.XYPairs.XYPair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='research.object_detection.protos.XYPairs.XYPair.x', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='y', full_name='research.object_detection.protos.XYPairs.XYPair.y', index=1,
...
_XYPAIRS = _descriptor.Descriptor(
  name='XYPairs',
  full_name='research.object_detection.protos.XYPairs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='x_y_pair', full_name='research.object_detection.protos.XYPairs.x_y_pair', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='training_data_type', full_name='research.object_detection.protos.XYPairs.training_data_type', index=1,
...
_SIGMOIDPARAMETERS = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.SigmoidParameters',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='a', full_name='research.object_detection.protos.SigmoidParameters.a', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='b', full_name='research.object_detection.protos.SigmoidParameters.b', index=1,
      number=2, type=2, cpp_type=6, label=1,
...
CalibrationConfig = _reflection.GeneratedProtocolMessageType('CalibrationConfig', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.CalibrationConfig)
  })
...
FunctionApproximation = _reflection.GeneratedProtocolMessageType('FunctionApproximation', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.FunctionApproximation)
  })
...
ClassIdFunctionApproximations = _reflection.GeneratedProtocolMessageType('ClassIdFunctionApproximations', (_message.Message,), {
  ...
  'ClassIdXyPairsMapEntry' : _reflection.GeneratedProtocolMessageType('ClassIdXyPairsMapEntry', (_message.Message,), {
    ...
    '__module__' : 'research.object_detection.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:research.object_detection.protos.ClassIdFunctionApproximations.ClassIdXyPairsMapEntry)
    })
  ,
  'DESCRIPTOR' : _CLASSIDFUNCTIONAPPROXIMATIONS,
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.ClassIdFunctionApproximations)
  })
...
SigmoidCalibration = _reflection.GeneratedProtocolMessageType('SigmoidCalibration', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.SigmoidCalibration)
  })
...
ClassIdSigmoidCalibrations = _reflection.GeneratedProtocolMessageType('ClassIdSigmoidCalibrations', (_message.Message,), {
  ...
  'ClassIdSigmoidParametersMapEntry' : _reflection.GeneratedProtocolMessageType('ClassIdSigmoidParametersMapEntry', (_message.Message,), {
    ...
    '__module__' : 'research.object_detection.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:research.object_detection.protos.ClassIdSigmoidCalibrations.ClassIdSigmoidParametersMapEntry)
    })
  ,
  'DESCRIPTOR' : _CLASSIDSIGMOIDCALIBRATIONS,
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.ClassIdSigmoidCalibrations)
  })
...
TemperatureScalingCalibration = _reflection.GeneratedProtocolMessageType('TemperatureScalingCalibration', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.TemperatureScalingCalibration)
  })
...
XYPairs = _reflection.GeneratedProtocolMessageType('XYPairs', (_message.Message,), {
  ...
  'XYPair' : _reflection.GeneratedProtocolMessageType('XYPair', (_message.Message,), {
    ...
    '__module__' : 'research.object_detection.protos.calibration_pb2'
    # @@protoc_insertion_point(class_scope:research.object_detection.protos.XYPairs.XYPair)
    })
  ,
  'DESCRIPTOR' : _XYPAIRS,
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.XYPairs)
  })
...
SigmoidParameters = _reflection.GeneratedProtocolMessageType('SigmoidParameters', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.calibration_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.SigmoidParameters)
  })
