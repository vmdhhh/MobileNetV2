...
# source: research.object_detection/protos/region_similarity_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='research.object_detection/protos/region_similarity_calculator.proto',
  package='research.object_detection.protos',
  syntax='proto2',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n:research.object_detection/protos/region_similarity_calculator.proto\x12\x17research.object_detection.protos\"\xde\x02\n\x1aRegionSimilarityCalculator\x12N\n\x16neg_sq_dist_similarity\x18\x01 \x01(\x0b\x32,.research.object_detection.protos.NegSqDistSimilarityH\x00\x12@\n\x0eiou_similarity\x18\x02 \x01(\x0b\x32&.research.object_detection.protos.IouSimilarityH\x00\x12@\n\x0eioa_similarity\x18\x03 \x01(\x0b\x32&.research.object_detection.protos.IoaSimilarityH\x00\x12W\n\x1athresholded_iou_similarity\x18\x04 \x01(\x0b\x32\x31.research.object_detection.protos.ThresholdedIouSimilarityH\x00\x42\x13\n\x11region_similarity\"\x15\n\x13NegSqDistSimilarity\"\x0f\n\rIouSimilarity\"\x0f\n\rIoaSimilarity\"6\n\x18ThresholdedIouSimilarity\x12\x1a\n\riou_threshold\x18\x01 \x01(\x02:\x03\x30.5'
)
...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.RegionSimilarityCalculator',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='neg_sq_dist_similarity', full_name='research.object_detection.protos.RegionSimilarityCalculator.neg_sq_dist_similarity', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='iou_similarity', full_name='research.object_detection.protos.RegionSimilarityCalculator.iou_similarity', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ioa_similarity', full_name='research.object_detection.protos.RegionSimilarityCalculator.ioa_similarity', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='thresholded_iou_similarity', full_name='research.object_detection.protos.RegionSimilarityCalculator.thresholded_iou_similarity', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='region_similarity', full_name='research.object_detection.protos.RegionSimilarityCalculator.region_similarity',
...
_NEGSQDISTSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.NegSqDistSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_IOUSIMILARITY = _descriptor.Descriptor(
  name='IouSimilarity',
  full_name='research.object_detection.protos.IouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_IOASIMILARITY = _descriptor.Descriptor(
  name='IoaSimilarity',
  full_name='research.object_detection.protos.IoaSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_THRESHOLDEDIOUSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='research.object_detection.protos.ThresholdedIouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='research.object_detection.protos.ThresholdedIouSimilarity.iou_threshold', index=0,
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.RegionSimilarityCalculator)
  })
...
NegSqDistSimilarity = _reflection.GeneratedProtocolMessageType('NegSqDistSimilarity', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.NegSqDistSimilarity)
  })
...
IouSimilarity = _reflection.GeneratedProtocolMessageType('IouSimilarity', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.IouSimilarity)
  })
...
IoaSimilarity = _reflection.GeneratedProtocolMessageType('IoaSimilarity', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.IoaSimilarity)
  })
...
ThresholdedIouSimilarity = _reflection.GeneratedProtocolMessageType('ThresholdedIouSimilarity', (_message.Message,), {
  ...
  '__module__' : 'research.object_detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:research.object_detection.protos.ThresholdedIouSimilarity)
  })
