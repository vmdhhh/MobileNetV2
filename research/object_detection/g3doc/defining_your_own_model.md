...
## DetectionModels (`research.object_detection/core/model.py`)
...
implement the `DetectionModel` interface (see the full definition in `research.object_detection/core/model.py`).  In particular,
...
`research.object_detection/meta_architectures/faster_rcnn_meta_arch.py` for definitions
...
See the `research.object_detection/models/faster_rcnn_resnet_v1_feature_extractor.py`
...
extractor with the model builder (`research.object_detection/builders/model_builder.py`),
...
`research.object_detection/builders/model_builder.py` file.
We recommend adding a test in `research.object_detection/builders/model_builder_test.py`
